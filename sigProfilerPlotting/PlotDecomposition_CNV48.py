...
import sigProfilerPlotting as sp_plots
...
def plot_7_plus(bases, project, c_draw, denovo_plots_dict, basis_plots_dict):
	...
	c_draw.drawString(GRAPH_X_COORD - 331, (TEXT_Y_COORD - HEIGHT_GRAPH * 6) - 10 + 567, extra_sigs)
...
def gen_plot(de_novo_name, bases, output_path, project, c, reconstruction, \
	...
	if reconstruction:
		...
		# IMPORTANT: Add this in later, currently don't have statistics parameter
...
def gen_decomposition(denovo_name, basis_names, weights, output_path, project, \
	...
	pdf_file = PdfFileReader(buff, "rb")
	merger.append(pdf_file)
	merger.write("uncropped.pdf")
